use crate::carts::mappers::cnrom::CNROM;
use crate::carts::mappers::mmc1::MMC1;
use crate::carts::mappers::mmc3::MMC3;
use crate::carts::mappers::nrom::NROM;
use crate::carts::mappers::uxrom::UxROM;
